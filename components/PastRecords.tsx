        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center mb-5 sm:mb-6">
              <Trophy className="w-14 h-14 sm:w-16 sm:h-16 lg:w-20 lg:h-20 text-yellow-400" />
            </div>
            <div className="text-5xl sm:text-6xl lg:text-7xl font-bold text-yellow-400 mb-4 sm:mb-5">
              28%
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            ...
            >
              <TrendingUp className="w-12 h-12 sm:w-14 sm:h-14 text-yellow-400 mx-auto mb-4" />
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#d82209] to-[#b91c1c] rounded-xl p-6 sm:p-7 border border-[#d82209] text-center shadow-md"
            >
              <Award className="w-12 h-12 sm:w-14 sm:h-14 text-yellow-400 mx-auto mb-4" />
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#d82209] to-[#b91c1c] rounded-xl p-6 sm:p-7 border border-[#d82209] text-center shadow-md"
            >
              <Users className="w-12 h-12 sm:w-14 sm:h-14 text-yellow-400 mx-auto mb-4" />
