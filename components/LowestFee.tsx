...
export default function LowestFee() {
  return (
    <section className="py-12 sm:py-16 bg-[#d82209]/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-white rounded-xl p-6 sm:p-8 lg:p-10 shadow-md border-2 border-[#d82209]/30">
            <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 mb-6 sm:mb-8">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-[#d82209] to-[#b91c1c] rounded-full flex items-center justify-center shadow-md">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-base sm:text-lg text-gray-700">
                  Participate in AMRC-SAT to get admission  at the lowest
                  possible fee
                </p>
              </div>
            </div>
